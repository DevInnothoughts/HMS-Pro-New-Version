...
const DoctorsDischargeCardDetails = ({ navigation }) => {
  ...
  const fetchDCBills = async (location, from, to) => {
    ...
    try {
      ...
      console.log(number);
      fetch(
        `${BACKEND_URL}/Dashboard/doctorsDischargeCard?location=${location}&from=${from}&to=${to}&mobile=${number}`,
        requestOptions,
      )
        .then(response => response.json())
        .then(res => {
          console.log('Bill details: ', res);
          setDCData(res.dischargeCards);
        })
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Text style={styles.medium}>{item.patient_name}</Text>
                      {expandedPatientId === item.patient_id && (
                        <>
...
export default DoctorsDischargeCardDetails;
