  ...
  const fetchPatientData = async (location, patientId) => {
    try {
      ...
      const response = await fetch(
        `${BACKEND_URL}/Patient/diagnosis?location=${location}&patientId=${patientId}`,
        {
          method: 'GET',
          headers: {
      ...
      <View style={styles.card}>
        ...
        <View style={styles.itemContainer2}>
          ...
          <View style={styles.detailContainer}>
            <Text style={styles.infoLabel}>{patient.Uid_no || 'NA'}</Text>
          </View>
          <View style={styles.detailContainer}>
            <Text style={styles.infoLabel}>
              First Visit : {new Date(patient.date).toLocaleDateString()}
            </Text>
          </View>
          <View style={styles.detailContainer}>
            <Text style={styles.infoLabel}>Gender : {patient.sex}</Text>
          </View>
          <View style={styles.detailContainer}>
            <Text style={styles.infoLabel}>Age : {patient.age}</Text>
          </View>
          <View style={styles.detailContainer}>
            <Text style={styles.infoLabel}>Mobile-1 : {patient.phone}</Text>
          </View>
          <View style={styles.detailContainer}>
            <Text style={styles.infoLabel}>Mobile-2 : {patient.mobile_2}</Text>
          </View>
        </View>
